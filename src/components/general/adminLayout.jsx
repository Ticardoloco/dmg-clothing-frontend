  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row text-gray-800 antialiased">
      ...
      <div className="flex items-center justify-between md:hidden bg-white border-b border-gray-200 px-5 py-4 w-full fixed top-0 left-0 z-40 h-16">
        ...
        <span className="font-prata text-lg lg:text-xl uppercase tracking-wider text-indigo-600">
          DMG Studio
        </span>
      ...
      <aside
        ...
        transform transition-transform duration-300 ease-in-out md:translate-x-0 md:h-screen md:sticky md:top-0
      ...
      >
        <div className="space-y-10">
          ...
          <div className="flex items-center justify-between mt-2 md:mt-0">
            <div className="text-lg md:text-xl font-prata tracking-wide text-gray-900 uppercase">
              DMG Admin
            </div>
            <button
              onClick={() => setIsSidebarOpen(false)}
        ...
        <button
          ...
          className="text-left text-sm uppercase tracking-widest text-red-600 hover:text-red-800 font-bold transition-colors pt-6 border-t border-gray-100"
        >
          Logout Admin Panel
        </button>
      </aside>
      ...
      <main className="flex-1 p-3 sm:p-8 lg:p-12 pt-24 md:pt-10 min-w-0">
        {children}
      </main>
    </div>
  );
