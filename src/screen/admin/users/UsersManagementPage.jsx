...
//   return (
//     <span className={`inline-flex items-center px-2 py-0.5 border text-[9px] font-bold uppercase tracking-widest ${badgeStyle}`}>
//       {role}
//     </span>
//   );
// };
...
//                     <div className={`inline-flex items-center gap-1.5 px-2 py-0.5 border ${statusStyles.badge}`}>
...
//                       >
//                         <option value="active" className="bg-white text-gray-900">Status: Active</option>
//                         <option value="suspended" className="bg-white text-gray-900">Status: Suspended</option>
//                       </select>
//                     </div>

//                     {/* Hardcoded SVG Delete Action Button (Matches Order layout fallback sizing) */}
//                     <button
...
//                 {/* Main Identity Content Block */}
//                 <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-6 text-xs items-center">
//                   {/* Profile Details */}
...
//                   {/* System Authority Rights preview */}
//                   <div className="flex flex-col items-start md:items-end justify-center">
//                     <span className="text-[8px] uppercase tracking-wider text-gray-400 font-bold block mb-1">
//                       Privilege Classification
//                     </span>
//                     <UserRoleBadge role={user.isAdmin === true ? "admin" : "customer"} />
//                   </div>
//                 </div>
