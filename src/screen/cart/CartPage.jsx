    ...
    <div className='pt-28 pb-20 px-6 max-w-7xl mx-auto'>
      ...
      <div className='flex flex-col lg:flex-row gap-16'>
        ...
        <div className='flex-1 flex flex-col gap-8'>
              ...
              <div key={index} className='flex gap-6 border-b border-gray-50 group'>
                ...
                <div className='flex-1 flex flex-col justify-between'>
                  <div>
                    ...
                    {item.color && (
                      <p className='text-[10px] font-bold text-indigo-600 uppercase tracking-widest mt-1'>Color: {item.color}</p>
                    )}
                  </div>
                  ...
                  <div className='flex justify-between items-center mt-2'>
                    ...
                    {/* Remove Button */}
                    <button onClick={() => removeItem(item._id, item.size, item.color)} className='text-[10px] font-bold uppercase tracking-widest text-gray-400 hover:text-red-500 transition-colors cursor-pointer'>
                      Remove
                    </button>
                  </div>
                </div>
          ...
          {cart.length > 0 && (
            <button onClick={() => clearCart()} className="mt-6 inline-block bg-black text-white px-8 py-4 text-xs font-bold uppercase tracking-widest hover:bg-indigo-600 transition-colors cursor-pointer">Clear all</button>
          )}
        ...
        <div className='w-full lg:w-96'>
          <div className='bg-gray-50 p-8 sticky top-32'>
            ...
            <button onClick={() => router.push('place-order')} className='w-full bg-black text-white mt-10 py-5 text-xs font-bold uppercase tracking-[0.2em] hover:bg-indigo-600 transition-colors shadow-lg cursor-pointer'>
              Proceed to Checkout
            </button>
          </div>
        </div>
